    ...
    return (
        <section className="relative bg-black min-h-screen flex items-center">
            <div className="w-full">
                <h2 className="text-center text-3xl md:text-4xl font-bold mb-8 text-white tracking-wide">
                    OUR VISION
                </h2>
                <p className="max-w-3xl mx-auto text-lg md:text-xl text-white leading-relaxed text-left px-4">
        ...
        <div
            className="w-full h-full bg-gradient-to-tr from-purple-700 to-purple-400"
