...
import { Calendar, MapPin, Users, Clock, Users as Group, Star, Lightbulb, Award } from 'lucide-react';
    ...
    <section className="px-4 py-20  text-white">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex justify-center">
          <div className="bg-purple-900/40 p-1 rounded-full flex gap-2 border border-purple-600/20">
        ...
        {/* Session Details */}
        <div className="bg-gradient-to-br from-gray-900/60 to-black/50 rounded-3xl border border-purple-500/20 p-8 md:p-12 grid lg:grid-cols-2 gap-12">
          {/* Left Column */}
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3 text-sm sm:text-base text-purple-100">
            ...
            <div className="bg-purple-900/30 border border-purple-500/20 rounded-2xl p-6">
              <h3 className="text-lg md:text-xl font-semibold text-purple-200 mb-2">Featured Mentor</h3>
              <h4 className="text-xl font-bold">{data.mentor.name}</h4>
              <p className="text-purple-300 mb-2">{data.mentor.role}</p>
              <p className="text-sm text-purple-100">{data.mentor.bio}</p>
            </div>
          </div>

          {/* Right Column - Itinerary */}
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
              Session Itinerary
            </h3>
            ...
            <div className="space-y-4">
              {itinerary.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="flex items-center justify-between p-4 bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-xl border border-purple-500/10 hover:border-purple-500/30 transition-all"
                  >
